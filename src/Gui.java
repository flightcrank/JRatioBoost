...
public class Gui extends javax.swing.JFrame {
	 ...
	 */
        ...
        private void initComponents() {
                ...
                jLabel4.setIcon(new javax.swing.ImageIcon("/home/karma/Code/java/j-ratio-boost/src/icons/edit-number.png")); // NOI18N
	 ...
	 */
	public void stopAction(int tIndex) {
	...
	private void connectButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (connectButton.getText().equals("Connect")) {
			...
			StartConnectionTask sct = new StartConnectionTask(te, this);
			sct.execute();
	 ...
	 */
		...
		if (!s.equals("0")) {
			...
			for (int i = 0; i < te.getErrorMsg().size(); i++) {
				...
				String[] errMsg = te.getErrorMsg().get(i).split(":");
				String tmp = String.format("<br /><center><font size=\"6\" color=\"#FF000000\">%s</font></center>\n", errMsg[0]);
				line = line.concat(tmp);
				line = line.concat(String.format("<font size=\"5\">%s</font><br />", errMsg[1]));
			}
	...
	/**
	 * This method get called periodically to update the progress bar and run the torrent for the specified update interval received from the tracker.
	 **/

	public void periodicUpdate(TorrentElement te)  {
		...
		if (te.getTimeLeft() <= 0) {
			...
			//stop the timer thread from executing to prevent the timer 
			//from continuing to execute while the http request is being made
			//by the TrackerConnect instance
			timer.stop();
				
			UpdateConnectionTask uct = new UpdateConnectionTask(te, this);
			uct.execute();
		}
		...
		if (te.getIndex() == indexSelected) {
			...
			String timeLeft = Gui.formatSeconds(te.getTimeLeft());
	...
	private class customRenderer extends DefaultListCellRenderer {
        ...
        public javax.swing.JPanel WindowPanel;
        ...
        public javax.swing.JButton errorsButton;
        ...
        public javax.swing.JList<String> torrentList;
